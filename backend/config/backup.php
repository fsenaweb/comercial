...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            // 'local' aqui é sempre gravado (não depende de internet). Upload para o
            // Google Drive é bônus e será plugado como um disk adicional futuramente
            // (ver docs/01-architecture.md, seção Backup e Recuperação).
            'disks' => [
                'backups',
            ],
        ],
